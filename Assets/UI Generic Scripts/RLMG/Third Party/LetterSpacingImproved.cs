...
namespace UnityEngine.UI
{
	...
	public class LetterSpacingImproved : BaseMeshEffect
	{
		...
		protected LetterSpacingImproved() { }
        ...
        */
		...
		public void ModifyVertices(List<UIVertex> verts)
		{
			...
			for (int lineIdx = 0; lineIdx < lines.Length; lineIdx++)
			{
				...
				{
                    // In Unity 2019.1.5f1 the "space" character does not generete verts
                    if (line[charIdx] == ' ')
                        continue;
                ...
                // In Unity 2019.1.5f1 the "Carriage return" character does not generete verts
                //glyphIdx++;
            }
        }
